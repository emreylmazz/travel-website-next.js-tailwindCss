...
const CampSite = ({backgroundImage,subtitle,title,peopleJoined}:
  CampProps) => {
  return(
    <div className={`h-full w-full mim-w-[1100px] ${backgroundImage}
...
overflow-hidden rounded-3xl'>
  <h2 className='regular-24 md:regular-32 2xl:regular-64 capitalize text-white'>
    ...
    <p className='regular-14 xl:regular-16 mt-5 text-white'>
      Starting from the anxiety of the climbers when visiting a new climbing location, the possibility of getting lost is
      very large. That's why we are here for those of you who want to start an advanture
    </p>
    <Image 
            src="/quote.svg"
            alt="camp-2"
